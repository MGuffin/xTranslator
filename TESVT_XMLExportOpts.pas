...
unit TESVT_XMLExportOpts;

interface

uses
   Controls, Forms, StdCtrls, ExtCtrls, TESVT_Ressources, Classes;

type
  TFormXmlOpt = class(TForm)
...
var
  FormXmlOpt: TFormXmlOpt;

implementation

{$R *.dfm}

procedure TFormXmlOpt.FormCreate(Sender: TObject);
begin
  init_caption(self);
end;
